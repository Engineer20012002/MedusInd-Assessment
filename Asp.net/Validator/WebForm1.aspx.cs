...
namespace WebApplication6
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        {
            string connectionString = "Data source=DESKTOP-5KIBVA6\\SQLEXPRESS; initial catalog=master;integrated security = true;";
            SqlConnection con = new SqlConnection(connectionString);
            SqlCommand command = new SqlCommand("Product9", con);
